            ...
            <div className="md:hidden" id="mobile-menu">
              <div className="bg-neutral-900 mt-4 p-3 space-y-1">
                <div id="icons" className="py-2 flex">
                  <div className="w-8 h-8 pl-2 px-1 width-bb hover:cursor-pointer text-white opacity-75 hover:opacity-100">
                    <a target="_blank" href="mailto:bannersamuelson@gmail.com" rel="noreferrer">
                      <img src={mail} alt="email to icon" />
                    </a>
                  </div>
                  <div className="pl-2 px-1 hover:cursor-pointer text-white opacity-75 hover:opacity-100">
                  ...
                  <div className="px-1 hover:cursor-pointer text-white opacity-75 hover:opacity-100">
                ...
                <HashLink
                  to="/#home"
                  className="text-white rounded-md hover:bg-neutral-700 hover:text-white block px-3 py-2 text-base font-medium"
                  onClick={() => setIsOpen(!isOpen)}
                >
                  Home
                </HashLink>
