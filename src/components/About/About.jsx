...
export default function About() {
  return (
    <div id="about" className="bg-blen pt-14">
      ...
      <p className="mx-auto flex px-24 text-slate-300">
        <br /> Software Engineer with a speciality in Front-End design and layout implementations. Love to code and make webpages that push the industry standard. My current skills include but are not limited to:
