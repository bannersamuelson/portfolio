      ...
      <nav className="sticky">
        <div className="px-4 flex justify-between over:opacity-100 p-1">
          <div className="flex items-center">
            <HashLink to="/#home" className="text-slate-50 text-4xl logo border-2 circle hover:text-slate-200">B</HashLink>
            <div id="icons" className="hidden md:flex">
          ...
          {(ref) => (
            <div className="md:hidden" id="mobile-menu">
              <div ref={ref} className="bg-slate-900 mt-1 p-3 space-y-1">
                ...
                <a
                  href="#"
                  className="text-slate-50 hover:bg-slate-800 rounded-md block px-3 py-2 text-base font-medium"
                >
                  Home
                </a>
