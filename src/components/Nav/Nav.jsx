      ...
      <nav>
        <div className="px-4 pt-4 flex justify-between over:opacity-100 ">
          <div className="flex items-center">
            <HashLink to="/#home" className="text-slate-600 ml-1 w-bb text-4xl logo circle fixed"><img src={Logo} alt="logo" /></HashLink>
          </div>
          <div className="px-4 py-1 pt-1 hidden md:block align-center">
            <div className="align-center items-center ml-10 text-lg text-slate-50 space-x-4 flex">
              <HashLink to="/#home" className="text-slate-600 hover:text-slate-600 focus:text-slate-90 m-1 px-2 py-1 rounded-md font-medium">Home</HashLink>
              <HashLink to="/#projects" className="text-slate-600 hover:text-slate-600  m-1 px-2 py-1 rounded-md font-medium">Projects</HashLink>
              <HashLink to="/#about" className="text-slate-600 hover:text-slate-600  m-1 px-2 py-1 rounded-md font-medium">About</HashLink>
              <HashLink to="/#contact" className="text-slate-600 hover:text-slate-600  m-1 px-2 py-1 rounded-md font-medium">Contact</HashLink>
            </div>
          </div>
            ...
            <div className="md:hidden" id="mobile-menu">
              <div className="bg-neutral-900 mt-4 p-3 space-y-1">
                <div id="icons" className="py-2 flex">
                  ...
                  <div className="px-1 hover:cursor-pointer text-slate-600 opacity-75 hover:opacity-100">
                ...
                <HashLink
                  to="/#home"
                  className="text-slate-600 rounded-md hover:bg-neutral-700 hover:text-white block px-3 py-2 text-base font-medium"
                  onClick={() => setIsOpen(!isOpen)}
                >
                  Home
                </HashLink>
